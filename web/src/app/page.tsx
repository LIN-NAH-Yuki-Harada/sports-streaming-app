          ...
          <div className="relative">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">ホーム画面に追加するだけ</p>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-4 pt-3 border-t border-white/5">
              <div className="flex-1 rounded-lg bg-black/40 px-3 py-2.5">
                <p className="text-[11px] text-[#e63946] font-bold mb-1">iPhone</p>
                <p className="text-[11px] text-gray-500">共有ボタン □↑ → ホーム画面に追加</p>
              </div>
              <div className="flex-1 rounded-lg bg-black/40 px-3 py-2.5">
                <p className="text-[11px] text-[#e63946] font-bold mb-1">Android</p>
                <p className="text-[11px] text-gray-500">メニュー ︙ → ホーム画面に追加</p>
              </div>
            </div>
          </div>
        </div>
