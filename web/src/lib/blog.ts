...
export const POSTS: Post[] = [
  ...
  {
    slug: "bukatsu-team-douga-kyoyu",
    title:
      "部活・スポ少の動画共有アプリの選び方｜チームで試合を配信し、保護者全員に届ける方法",
    description:
      "部活・スポーツ少年団で使う動画共有アプリの選び方と、チーム単位で試合を配信・共有する方法。毎回リンクを配る手間、卒団でリンクが切れる問題、役割分担までまとめました。",
    excerpt:
      "「今週の試合、誰か撮れますか？」「動画どこですか？」を毎回やりとりするのをやめたい。チーム単位で配信と共有を回すと何が変わるのかを、運営する側の目線で整理しました。",
    ...
    sections: [
      {
        ...
        note: "配る作業は1回あたり数分でも、試合ごとに発生します。週末に2試合あるチームなら、年間で100回を超えます。",
      },
      {
        heading: "チーム単位にすると何が変わるか",
        paragraphs: [
      ...
      {
        heading: "動画共有アプリの選び方：方法は3つ、続けやすさで選ぶ",
        paragraphs: [
        ...
        note: "どれを選ぶかは「1年続けられるか」で判断すると外れません。最初の1回が楽な方法ほど、10回目がつらくなる傾向があります。",
      },
      {
        heading: "試合予定も同じ場所に置いておく",
        paragraphs: [
      ...
      {
        heading: "🔴 落とし穴：卒団すると、リンクが切れることがあります",
        paragraphs: [
      ...
      },
      {
        ...
        note: "「公開」と「限定公開」は別物です。限定公開はURLを知っている人だけが見られる状態で、検索には出ません。ただしURLが転送されれば第三者も見られるため、チーム内共有の仕組みがある方が安全です。",
      },
      {
        heading: "役割を分けると、続きます",
        paragraphs: [
        ...
        note: "撮影と得点入力を分けると、撮る人が画面操作から解放されます。実際、この分担ができているチームほど配信が続いています。",
      },
      {
        heading: "まとめ",
        list: [
      ...
      },
      {
        ...
        note: "まずは無料で、合計10分までお試しいただけます（カード登録は不要です）。",
      },
    ],
  },
];
