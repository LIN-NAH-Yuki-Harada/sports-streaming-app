  ...
  return (
    <div>
      ...
      <div className="space-y-2.5">
        ...
        <button
          disabled
          className="w-full flex items-center justify-center gap-3 bg-[#06C755]/50 text-white/50 text-sm font-semibold py-2.5 rounded-md cursor-not-allowed"
        >
        ...
        <button
          disabled
          className="w-full flex items-center justify-center gap-3 bg-[#1877F2]/50 text-white/50 text-sm font-semibold py-2.5 rounded-md cursor-not-allowed"
        >
